...
class CircuitGrid extends Component {
    ...
    getSVG = () => {
        return <div style={styles.svg_container}>
    ...
    ">
                        <ellipse cx={290} cy={238} rx={48} ry={32} fill="#ffffff" stroke="#000000"
                                 pointerEvents="none"/>
                    </g>
    ...
    ">
                        <ellipse cx={770} cy={238} rx={48} ry={32} fill="#ffffff" stroke="#000000"
                                 pointerEvents="none"/>
                    </g>
